...
//To jest komentaż do tego pliku. Ten plik jest ewidentnie źle
//sformatowany i należy to koniecznie poprawić, pamiętając o nazwach zmiennych
//dopuszczalnej długości linii, znakach z kodu ANSI, wcięciach i dbalości o wsykoiehj jakosci kometarze

int main(){
int PierwszaZmien a = 5; int Drugazmienna = 7;
